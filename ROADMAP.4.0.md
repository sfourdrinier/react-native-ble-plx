...
`unified-ble-manager@4.0.0-alpha.25` is published under npm's `next` dist-tag
...
linking alpha.25's package artifact to a passed physical-radio backend scenario,
