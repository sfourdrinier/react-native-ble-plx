...
`unified-ble-manager@4.0.0-alpha.30` is the current published 4.0 alpha package.
...
Experimental, and no current evidence record binds the published alpha.30
...
L2/L3 evidence only; alpha.30 makes no Windows live-radio claim.
