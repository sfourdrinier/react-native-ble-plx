...
`unified-ble-manager@4.0.0-alpha.29` is the current published 4.0 alpha package.
...
Experimental, and no current evidence record binds the published alpha.29
...
L2/L3 evidence only; alpha.29 makes no Windows live-radio claim.
