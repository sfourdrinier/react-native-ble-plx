...
`unified-ble-manager@4.0.0-alpha.36` remains the published **Experimental**
prerelease. No current evidence record binds the published alpha.36 artifact
...
checks remain L2/L3 evidence only; alpha.36 makes no Windows live-radio claim.
