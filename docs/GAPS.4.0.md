...
must not be read as Preview-or-higher evidence for the alpha.26 candidate.
...
| WinRT | Mock TCK, native compile/Electron ABI, live radio | Compile/ABI proof is L2/L3 only; alpha.26 makes no Windows live-radio claim |
