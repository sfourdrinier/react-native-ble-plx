...
describe('4.0 documentation honesty', () => {
  ...
  test('migration documents the current v4 package without inventing a compatibility path', () => {
    ...
    expect(migration).toContain('unified-ble-manager@4.0.0-alpha.17')
  ...
  test('public README provides only current alpha.15 construction and plugin guidance', () => {
    ...
    expect(readme).toContain('unified-ble-manager@4.0.0-alpha.17')
    expect(readme).toContain('pnpm add unified-ble-manager@4.0.0-alpha.17')
  ...
  test('published alpha documentation preserves exact release, evidence, and deferral boundaries', () => {
    ...
    expect(release).toContain('v4.0.0-alpha.17')
