...
describe('4.0 documentation honesty', () => {
  ...
  test('public README provides only current alpha.28 prerelease construction and plugin guidance', () => {
  ...
  test('alpha.28 published documentation preserves exact release, evidence, and deferral boundaries', () => {
    const readme = read('README.md')
    const release = read('RELEASE.md')
