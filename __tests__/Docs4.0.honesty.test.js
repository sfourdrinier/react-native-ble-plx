...
describe('4.0 documentation honesty', () => {
  ...
  test('migration documents the current v4 package without inventing a compatibility path', () => {
    ...
    expect(migration).toContain('unified-ble-manager@4.0.0-alpha.32')
  ...
  test('public README provides only current alpha.32 prerelease construction and plugin guidance', () => {
    ...
    expect(readme).toContain('unified-ble-manager@4.0.0-alpha.32')
    expect(readme).toContain('pnpm add unified-ble-manager@4.0.0-alpha.32')
    expect(readme).toContain('`v4.0.0-alpha.31` is the previous published prerelease')
    expect(changelog).toContain('## [4.0.0-alpha.32] - 2026-08-01 (published prerelease)')
  ...
  test('alpha.32 published documentation preserves exact release, evidence, and deferral boundaries', () => {
    ...
    expect(release).toContain('v4.0.0-alpha.32')
