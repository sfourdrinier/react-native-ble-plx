...
`unified-ble-manager@4.0.0-alpha.33` was published from
`v4.0.0-alpha.33` by the protected GitHub Actions trusted-publishing workflow.
...
| --- | --- | --- | --- |
| Hyphenated SemVer prerelease, such as `4.0.0-alpha.33` | `next` | prerelease | Pin the exact version for reproducible evaluation; `@next` is mutable. |
