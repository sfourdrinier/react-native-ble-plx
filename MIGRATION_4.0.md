...
`unified-ble-manager@4.0.0-alpha.39` is the current published 4.0 prerelease. 4.0
...
`v4.0.0-alpha.38` is the previous published prerelease, not the
current prerelease.
...
current evidence record links alpha.39's published artifact to a hardware-backed
