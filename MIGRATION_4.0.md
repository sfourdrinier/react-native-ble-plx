...
`unified-ble-manager@4.0.0-alpha.28` is the current 4.0 prerelease candidate,
...
`next` is the mutable prerelease dist-tag; it must not be treated as alpha.28
...
current evidence record links alpha.28's candidate artifact to a hardware-backed
