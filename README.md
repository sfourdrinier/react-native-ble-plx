...
`unified-ble-manager@4.0.0-alpha.17` is the current public 4.0 prerelease for
...
`v4.0.0-alpha.17` is published to npm under the `next` dist-tag and has a
...
```sh
pnpm add unified-ble-manager@4.0.0-alpha.17
```
