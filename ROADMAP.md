...
**For the ambitious 4.x release train** (alpha → GA → multi-host preview including Electron native main process; TDD-first foundation; rename to **`unified-ble-manager`** across npm/CocoaPods/Android, with `@sfourdrinier/react-native-ble-plx` as npm shim), see **[ROADMAP.4.0.md](./ROADMAP.4.0.md)**.
