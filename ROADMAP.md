...
**For the ambitious 4.x release train** (alpha → GA → multi-host preview including Electron native main process; TDD-first foundation; package rename to **`unified-ble-manager`** with `@sfourdrinier/react-native-ble-plx` as shim), see **[ROADMAP.4.0.md](./ROADMAP.4.0.md)**.
